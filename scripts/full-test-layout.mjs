/**
 * Full test of the deterministic layout engine
 * Tests all templates for both scales and verifies:
 * 1. Loop closure (gap < 2mm)
 * 2. All connections between sequential pieces (gap < 1mm)
 * 3. Branch connections from turnouts
 * 4. All pieces are within board bounds
 */

import { execSync } from "child_process";

// We need to compile and run TypeScript. Let's use tsx.
// But first, let's write the actual test as a .ts file and run it with tsx.
...
writeFileSync("/home/node/.openclaw/workspace/lokopolis-app/scripts/full-test-layout.ts", testCode);
console.log("Test file written, now running...");
