          ...
          >
            ...
            >
              {activeComp.status === "active" && user && (
                ...
                >
                  <img src="https://psbeoiaqoreergwqzqoz.supabase.co/storage/v1/object/public/images/icons/competition-entry.png?v=6" alt="" style={{ width: "28px", height: "28px", objectFit: "contain", display: "inline-block", verticalAlign: "middle", marginRight: "8px" }} />
                  Přihlásit kolejiště
                </Link>
              )}
              {activeComp.status === "active" && !user && (
