  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "48px 20px" }}>
      <div style={{ marginBottom: "24px", fontSize: "13px", color: "var(--text-dimmer)" }}>
        ...
        <span style={{ color: "var(--text-muted)" }}>Nahlášené příspěvky</span>
      </div>
      ...
      <div style={{ display: "flex", gap: "8px", marginBottom: "24px", flexWrap: "wrap" }}>
        {([
          ...
          <button
            ...
            style={{
              padding: "8px 16px",
              background: filter === f.value ? "var(--accent-border)" : "var(--bg-card)",
      ...
      {loading ? (
        ...
        <div style={{ textAlign: "center", padding: "64px 0" }}>
          <div style={{ fontSize: "48px", marginBottom: "16px" }}>✅</div>
          <p style={{ color: "var(--text-dim)", fontSize: "16px" }}>Žádná nahlášení</p>
        </div>
      ) : (
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "12px", marginBottom: "12px" }}>
                  <div>
                    <div style={{ fontSize: "12px", color: "var(--text-faint)", marginBottom: "4px" }}>
                      Nahlásil: <span style={{ color: "var(--text-muted)" }}>{reporterName}</span> · {timeAgo(r.created_at)}
                    </div>
                    <Link href={targetLink} style={{ fontSize: "15px", fontWeight: 600, color: "var(--text-body)", textDecoration: "none" }}>
                      {targetTitle}
                    </Link>
                  </div>
                  <span style={{
                    ...
                    fontWeight: 600,
                    background:
                      r.status === "pending" ? "var(--accent-border)" :
